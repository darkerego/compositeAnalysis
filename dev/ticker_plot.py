...
class TaGenerator:
    ...
    def __init__(self, trading_pair, interval, limit=100):
        self.rc_params = {
            "lines.color": "white",
        ...
        self.klines = self.trader.client.fetch_ohlcv(symbol=trading_pair, timeframe=interval, limit=limit)
...
if __name__ == '__main__':  # TODO: change dest from 'pair' to symbol, and 'interval' to 'period'
    ...
    try:
        tagen = TaGenerator(trading_pair=args.pair, interval=args.interval, limit=args.limit)
